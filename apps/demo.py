...
def main():
    ...
    server_thread = threading.Thread(target=watch_for_messages_server,
                                     args=(server_oram, ))
    server_thread.start()
    client_oram.write_block(0, b"abcd"*16)
    # If this gets uncommented there is a bug
    # But it is too late at night to fix right now
    #client_oram.write_block(1, b"abcd"*16)
